...
- [ ] A Python 3.11+ virtualenv lives at `./.venv` with the package installed editable (`uv pip install -e ".[dev]"`).
...
7. **Anything skipped:** e.g. `texlive-core` if they declined, iCloud symlink if they declined.
